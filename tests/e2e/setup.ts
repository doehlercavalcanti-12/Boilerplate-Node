...
process.env.JWT_SECRET = process.env.JWT_SECRET ?? 'test-secret-key-test-secret-key-1234';
...
let serverInstance: Awaited<ReturnType<typeof import('../../src/server.js')['buildServer']>>;
